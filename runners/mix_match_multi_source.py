...
from utils import (
    ...
    make_combined_multi_source_dataset, copy_runner, get_time_string, get_preprocessor_config
)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source_domains', type=str, default='0,1,2')
    ...
    dataset = make_combined_multi_source_dataset(
